  ...
  <section class="panel">
    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="员工" name="users">
        <div class="toolbar">
          ...
          <el-tree-select v-model="query.deptId" :data="deptTree" :props="deptTreeProps" node-key="id" check-strictly clearable default-expand-all placeholder="部门" style="width: 200px" />
    ...
    <el-dialog v-model="userDialog.visible" :title="userDialog.form.id ? '编辑员工' : '新增员工'" width="720px">
      <el-form :model="userDialog.form" label-width="92px">
        <div class="form-grid">
          ...
          <el-form-item label="部门"><el-tree-select v-model="userDialog.form.deptId" :data="deptTree" :props="deptTreeProps" node-key="id" check-strictly clearable default-expand-all /></el-form-item>
    ...
    <el-dialog v-model="deptDialog.visible" :title="deptDialog.form.id ? '编辑部门' : '新增部门'" width="560px">
      <el-form :model="deptDialog.form" label-width="92px">
        <el-form-item label="上级部门"><el-tree-select v-model="deptDialog.form.parentId" :data="deptTree" :props="deptTreeProps" node-key="id" check-strictly clearable default-expand-all /></el-form-item>
