...
VALUES
    ...
    -- 2026-07-14 (准时打卡 + 准时加班 OVERTIME)
    (4, 2, '2026-07-14', '2026-07-14 08:55:00', '127.0.0.1', '正常上班', '2026-07-14 21:05:00', '127.0.0.1', '加班完毕', 720, 0, 0, 'NORMAL', 'USER_CHECK'),
    -- 2026-07-13 (不准时打卡迟到 + 晚下班加班 OVERTIME)
    (4, 2, '2026-07-13', '2026-07-13 09:15:00', '127.0.0.1', '迟到了', '2026-07-13 22:00:00', '127.0.0.1', '冲刺加班', 765, 15, 0, 'LATE', 'USER_CHECK'),
    -- 2026-07-12 (上班缺卡 MISSING_CARD)
    (4, 2, '2026-07-12', NULL, NULL, '忘记打卡', '2026-07-12 18:05:00', '127.0.0.1', '正常下班', 0, 0, 0, 'MISSING_CARD', 'USER_CHECK'),
    -- 2026-07-11 (下班缺卡 MISSING_CARD) - 故意不申请，测试扣款
...
VALUES
    ...
    (103, 'CORR2026072201', 4, 2, 'CORRECTION', '考勤补卡申请(上班补卡)', '忘记打卡', '2026-07-22 09:00:00', '2026-07-22 09:00:00', 0, 2, 'PENDING'),
    (104, 'CORR2026072202', 4, 2, 'CORRECTION', '考勤补卡申请(下班补卡)', '手机没电', '2026-07-17 18:00:00', '2026-07-17 18:00:00', 0, 2, 'PENDING'),
    (105, 'OT2026071401', 4, 2, 'OVERTIME', '正常加班申请', '日常需求加班', '2026-07-14 18:00:00', '2026-07-14 21:00:00', 3.0, 2, 'PENDING'),
    (106, 'OT2026071301', 4, 2, 'OVERTIME', '晚下班冲刺加班申请', '项目交付延期冲刺', '2026-07-13 18:00:00', '2026-07-13 22:00:00', 4.0, 2, 'PENDING'),
    (107, 'CORR2026071201', 4, 2, 'CORRECTION', '考勤补卡申请(上班补卡)', '早上走得急忘了', '2026-07-12 09:00:00', '2026-07-12 09:00:00', 0, 2, 'PENDING');
...
VALUES
    (1, 4, NULL, 'CHECK_IN', '2026-07-22 09:00:00', '忘记打卡', 103, 'PENDING'),
    (2, 4, NULL, 'CHECK_OUT', '2026-07-17 18:00:00', '手机没电', 104, 'PENDING'),
    (3, 4, NULL, 'CHECK_IN', '2026-07-12 09:00:00', '早上走得急忘了', 107, 'PENDING');
