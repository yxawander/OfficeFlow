...
VALUES
    ...
    (106, 'OT2026071401', 4, 2, 'OVERTIME', '正常加班申请', '日常需求加班', '2026-07-14 18:00:00', '2026-07-14 21:00:00', 3.0, 2, 'APPROVED', '2026-07-14 17:00:00'),
    -- 2026-07-13 加班申请（审核中）
    (107, 'OT2026071301', 4, 2, 'OVERTIME', '晚下班冲刺加班申请', '项目交付延期冲刺', '2026-07-13 18:00:00', '2026-07-13 22:00:00', 4.0, 2, 'PENDING', NULL),
    -- 2026-07-12 补卡申请（已被驳回）
    (108, 'CORR2026071201', 4, 2, 'CORRECTION', '考勤补卡申请(上班补卡)', '早上走得急忘了', '2026-07-12 09:00:00', '2026-07-12 09:00:00', 0, 2, 'REJECTED', '2026-07-12 14:00:00');
...
VALUES
    (1, 4, NULL, 'CHECK_IN', '2026-07-22 09:00:00', '忘记打卡', 103, 'REVOKED'),
    (2, 4, NULL, 'CHECK_IN', '2026-07-21 09:00:00', '打卡机故障', 104, 'APPROVED'),
    (3, 4, NULL, 'CHECK_OUT', '2026-07-17 18:00:00', '手机没电', 105, 'PENDING'),
    (4, 4, NULL, 'CHECK_IN', '2026-07-12 09:00:00', '早上走得急忘了', 108, 'REJECTED');
